...
<form class="needs-validation pt-5" method="post" action="RegistrationServlet" novalidate>
  <div class="form-row">
    <div class="col-md-6 mb-3">
      <label for="nom">Nom</label>
      <input type="text" class="form-control" id="validationCustom01" value="Mark" name="nom" required>
